...
fl = True
while(i<len(lines)):
    if fl==True and i + 3 < len(lines) and lines[i]=="m" and lines[i+1]=="u" and lines[i+2]=="l" and lines[i+3]=="(":
        j = 0
        i = i + 4
        temp1 = 0
        temp2 = 0
        ...
        if flag:
            ...
            print(res,"res")
        i = i + j
    elif i + 3 < len(lines) and lines[i]=="d" and lines[i+1]=="o" and lines[i+2]=="(" and lines[i+3]==")":
        i = i + 4
        fl = True
    elif i + 5 < len(lines) and lines[i]=="d" and lines[i+1]=="o" and lines[i+2]=="n" and lines[i+3]=="'" and lines[i+4]=="t" and lines[i+5]=="(" and lines[i+6]==")": 
        i = i + 7
        fl = False
    else:
        i += 1
